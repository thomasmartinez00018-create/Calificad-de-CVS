    ...
    <>
      <div className="hidden md:flex w-72 bg-slate-950 h-full flex-col p-8 text-white shrink-0 border-r border-slate-800">
        <div className="flex items-center gap-3 mb-12">
          {/* CAMBIO DE COLOR: A Violeta para asegurar v2.0.0 */}
          <div className="bg-gradient-to-br from-violet-500 to-fuchsia-600 w-10 h-10 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/20 font-black text-white">G</div>
